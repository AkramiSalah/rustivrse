const monumentsList = [
    ...
    new Monument(181, 664, 50, "Giant Excavator", 'x', 30, 'v', 'v', 'v'),
    ...
    new Monument(695, 900, 38, "Bandit Camp", 'v', 0, 'v', 'x', 'v'),
    new Monument(1270, 220, 35, "Harbour", 'x', 0, 'v', 'x', 'v'),
    new Monument(1060, 95, 35, "Ferry Terminal", 'x', 0, 'v', 'x', 'v'),
    new Monument(735, 700, 35, "Dome", 'x', 30, 'v', 'x', 'v'),
    new Monument(1100, 1240, 40, "Junkyard", 'x', 0, 'v', 'x', 'v'),
    new Monument(1277, 1173, 35, "Lighthouse", 'x', 0, 'v', 'x', 'v'),
    new Monument(152, 945, 35, "Fishing Village", 'x', 0, 'v', 'x', 'v'),
    new Monument(1159, 950, 35, "Mining Outpost", 'x', 0, 'v', 'x', 'v'),
    new Monument(382, 456, 40, "Abandoned Supermarket", 'x', 0, 'v', 'x', 'v'),
    new Monument(745, 470, 40, "Large Barn", 'x', 0, 'v', 'x', 'v'),
    new Monument(1165, 480, 35, "Ranch", 'x', 0, 'v', 'x', 'v'),
    new Monument(1362, 60, 35, "Large Oil Rig", 'x', 0, 'v', 'v', 'v'),
    new Monument(66, 60, 35, "Small Oil Rig", 'x', 0, 'v', 'v', 'v'),
    new Monument(46, 1236, 35, "Underwater Labs", 'x', 0, 'v', 'v', 'v'),
