const monumentsList = [
    ...
    new Monument(1296, 836, 40, "Small Harbour", false, 0, true, false, true),
    ...
    new Monument(695, 900, 38, "Bandit Camp", true, 0, true, false, true),
    new Monument(1270, 220, 35, "Harbour", false, 0, true, false, true),
    new Monument(1060, 95, 35, "Ferry Terminal", false, 0, true, false, true),
    new Monument(735, 700, 35, "Dome", false, 30, true, false, true),
    new Monument(1100, 1240, 40, "Junkyard", false, 0, true, false, true),
    new Monument(1277, 1173, 35, "Lighthouse", false, 0, true, false, true),
    new Monument(152, 945, 35, "Fishing Village", false, 0, true, false, true),
    new Monument(1159, 950, 35, "Mining Outpost", false, 0, true, false, true),
    new Monument(382, 456, 40, "Abandoned Supermarket", false, 0, true, false, true),
    new Monument(745, 470, 40, "Large Barn", false, 0, true, false, true),
    new Monument(1165, 480, 35, "Ranch", false, 0, true, false, true),
